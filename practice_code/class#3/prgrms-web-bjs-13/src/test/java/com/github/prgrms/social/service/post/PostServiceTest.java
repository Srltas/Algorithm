...
class PostServiceTest {
  ...
  @Order(2)
  void 포스트를_수정한다() {
    Post post = postService.findById(Id.of(Post.class, 1L), Id.of(User.class, 1L), Id.of(User.class, 1L)).orElse(null);
    assertThat(post, is(notNullValue()));
    String contents = randomAlphabetic(40);
  ...
  @Order(3)
  void 포스트_목록을_조회한다() {
    List<Post> posts = postService.findAll(userId, userId,0, 20);
