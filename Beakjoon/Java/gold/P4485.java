...
public class P4485 {
    ...
    public void solution() throws IOException {
        while (true) {
            ...
            createList();
            distance[0] = array[0][0];
            dijkstra(new Edge(0, array[0][0]));

            bw.write("Problem " + count++ + ": " + distance[N - 1] + System.lineSeparator());
        }
        bw.flush();
            ...
            for (int j = 0; j < n; j++) {
                for (int k = 0; k < 4; k++) {
                    ...
                    if (nextI >= 0 && nextJ >= 0 && nextI < n && nextJ < n) {
                        ...
                        list[currIndex].add(new Edge(nextIndex, array[nextI][nextJ]));
                    }
                }
            }
        }
